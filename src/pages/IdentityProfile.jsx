            ...
            <div style={s.activityList}>
              {activity.map((item, i) => (
                <Link
                  ...
                  style={{
                    ...s.activityItem, textDecoration: 'none', cursor: 'pointer',
            ...
            {!confirmReset ? (
              <div style={s.settingsRow}>
                <div>
                  ...
                  <p style={s.settingsDesc}>Remove your passkey and all stored credentials. You'll need to re-register on your next visit.</p>
                </div>
...
const s = {
  ...
  verifiedBadge: {
    ...
    color: '#10B981', fontFamily: "'Inter', sans-serif", marginBottom: '28px', letterSpacing: '0.02em',
  },
  verifiedDot: { width: '6px', height: '6px', borderRadius: '50%', background: '#10B981', boxShadow: '0 0 6px #10B981', display: 'inline-block' },
  idTitle: { fontFamily: "'Inter', sans-serif", fontSize: '12px', fontWeight: 600, color: '#475569', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '8px' },
  idValue: { fontFamily: "'Inter', sans-serif", fontSize: '32px', fontWeight: 900, color: '#F8FAFC', letterSpacing: '0.08em', marginBottom: '32px' },
  metaRow: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '24px', flexWrap: 'wrap' },
  metaItem: { display: 'flex', flexDirection: 'column', gap: '4px', alignItems: 'center' },
  metaLabel: { fontFamily: "'Inter', sans-serif", fontSize: '11px', fontWeight: 600, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.08em' },
  metaValue: { fontFamily: "'Inter', sans-serif", fontSize: '15px', fontWeight: 700, color: '#F8FAFC' },
  metaDivider: { width: '1px', height: '32px', background: 'rgba(255,255,255,0.08)' },
  statsRow: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '32px' },
  statCard: { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '16px', padding: '20px 16px', textAlign: 'center', backdropFilter: 'blur(12px)' },
  statIcon: { display: 'flex', justifyContent: 'center', marginBottom: '10px' },
  statValue: { fontFamily: "'Inter', sans-serif", fontSize: '28px', fontWeight: 800, letterSpacing: '-0.03em', marginBottom: '4px' },
  statLabel: { fontFamily: "'Inter', sans-serif", fontSize: '11px', fontWeight: 600, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.06em' },
  section: { marginBottom: '32px' },
  sectionTitle: { fontFamily: "'Inter', sans-serif", fontSize: '13px', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '12px' },
  emptyState: { background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', padding: '40px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' },
  ...
  settingsCard: { background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', overflow: 'hidden' },
  settingsRow: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', padding: '20px 24px', flexWrap: 'wrap' },
  settingsLabel: { fontFamily: "'Inter', sans-serif", fontSize: '14px', fontWeight: 600, color: '#F8FAFC', marginBottom: '4px' },
  settingsDesc: { fontFamily: "'Inter', sans-serif", fontSize: '12px', color: '#475569', maxWidth: '340px' },
  resetBtn: { display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '9px 18px', borderRadius: '10px', background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.25)', color: '#EF4444', fontSize: '13px', fontWeight: 700, fontFamily: "'Inter', sans-serif", cursor: 'pointer', flexShrink: 0 },
  confirmBox: { padding: '24px' },
  confirmText: { fontFamily: "'Inter', sans-serif", fontSize: '14px', color: '#94A3B8', marginBottom: '16px' },
