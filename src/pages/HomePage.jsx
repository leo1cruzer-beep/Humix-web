...
const s = {
  ...
  dotGrid: { position: 'absolute', inset: 0, opacity: 0.3, zIndex: 0, pointerEvents: 'none' },
  heroInner: {
    position: 'relative', zIndex: 1, maxWidth: '720px', margin: '0 auto',
  ...
  headline: {
    ...
    fontSize: 'clamp(44px, 8vw, 88px)', letterSpacing: 'clamp(-2px, -0.04em, -4px)',
    lineHeight: 1.04, color: '#F8FAFC', marginBottom: '24px',
  },
  sub: {
    fontSize: 'clamp(16px, 2.2vw, 21px)', fontWeight: 500,
    color: 'rgba(255,255,255,0.4)', lineHeight: 1.6,
    maxWidth: '520px', marginBottom: '44px', letterSpacing: '-0.01em',
  },
  statsRow: { display: 'flex', alignItems: 'center', gap: '32px', flexWrap: 'wrap', justifyContent: 'center' },
  statDivider: { width: '1px', height: '32px', background: 'rgba(255,255,255,0.1)' },
  statItem: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3px' },
  statValue: { fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: '26px', color: '#F8FAFC', letterSpacing: '-0.03em' },
  statLabel: { fontSize: '12px', fontWeight: 500, color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase', letterSpacing: '0.08em' },
  cardsSection: { background: '#0A0A0A', padding: '100px 0', borderTop: '1px solid #1A1A1A' },
  cardsSectionHeader: { textAlign: 'center', marginBottom: '48px' },
  cardsSectionTitle: {
    fontFamily: "'Inter', sans-serif", fontWeight: 800,
    fontSize: 'clamp(28px, 4vw, 40px)', letterSpacing: '-0.04em', color: '#F8FAFC', marginBottom: '12px',
  },
  cardsSectionSub: { fontSize: '17px', color: '#64748B', fontWeight: 500 },
  cardsGrid: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' },
  howWrap: { background: '#080808', padding: '100px 0', borderTop: '1px solid #1A1A1A', borderBottom: '1px solid #1A1A1A' },
  ...
  stepBadge: {
    ...
    color: '#818CF8', fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: '17px',
    display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
  },
  stepConnector: {
    position: 'absolute', top: '22px', right: '-16px',
    width: '32px', borderTop: '2px dashed #1A1A1A', zIndex: 1,
  },
};
