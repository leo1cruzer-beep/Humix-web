            ...
            <div style={card}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  ...
                  <input value={product} onChange={e => setProduct(e.target.value)} placeholder="e.g. Online bookkeeping course for freelancers" style={inputStyle} onFocus={e => e.target.style.borderColor='rgba(255,255,255,0.24)'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
                <div>
                  <label style={labelStyle}>Offer / Promotion</label>
                  <input value={offer} onChange={e => setOffer(e.target.value)} placeholder="e.g. 50% off this weekend only, or free 7-day trial" style={inputStyle} onFocus={e => e.target.style.borderColor='rgba(255,255,255,0.24)'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
                <div>
                  <label style={labelStyle}>Target Audience</label>
                  <input value={audience} onChange={e => setAudience(e.target.value)} placeholder="e.g. Freelance designers earning $3K–$8K/month who hate doing taxes" style={inputStyle} onFocus={e => e.target.style.borderColor='rgba(255,255,255,0.24)'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
