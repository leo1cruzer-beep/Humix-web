            ...
            <div style={card}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  ...
                  <input value={industry} onChange={e => setIndustry(e.target.value)} placeholder="e.g. Online grocery delivery, EdTech, Electric vehicles, Telemedicine" style={inputStyle} onFocus={e => e.target.style.borderColor='#1B4FD8'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
                <div>
                  <label style={labelStyle}>Target Country / Region</label>
                  <input value={country} onChange={e => setCountry(e.target.value)} placeholder="e.g. Indonesia, Sub-Saharan Africa, Latin America" style={inputStyle} onFocus={e => e.target.style.borderColor='#1B4FD8'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
