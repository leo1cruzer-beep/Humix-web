            ...
            <div style={card}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  ...
                  <textarea value={idea} onChange={e => setIdea(e.target.value)} placeholder="e.g. SaaS platform that helps restaurants reduce food waste by predicting demand using AI, targeting mid-size restaurant chains in the US" rows={5} style={{ ...inputStyle, resize: 'vertical', lineHeight: 1.6, paddingTop: '10px' }} onFocus={e => e.target.style.borderColor='#1B4FD8'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input value={ask} onChange={e => setAsk(e.target.value)} placeholder="e.g. $500,000 or $2M" style={inputStyle} onFocus={e => e.target.style.borderColor='#1B4FD8'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
