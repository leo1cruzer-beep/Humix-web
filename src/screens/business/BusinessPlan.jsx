            ...
            <div style={card}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  ...
                  <textarea value={idea} onChange={e => setIdea(e.target.value)} placeholder="e.g. A mobile app that connects freelance nurses with clinics for short-term shifts in rural areas" rows={4} style={{ ...inputStyle, resize: 'vertical', lineHeight: 1.6, paddingTop: '10px' }} onFocus={e => e.target.style.borderColor='rgba(255,255,255,0.24)'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
                <div>
                  <label style={labelStyle}>Target Market</label>
                  <input value={market} onChange={e => setMarket(e.target.value)} placeholder="e.g. Small clinics, rural hospitals, healthcare staffing agencies" style={inputStyle} onFocus={e => e.target.style.borderColor='rgba(255,255,255,0.24)'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
                <div>
                  <label style={labelStyle}>Country / Region</label>
                  <input value={country} onChange={e => setCountry(e.target.value)} placeholder="e.g. Nigeria, Southeast Asia, United Kingdom" style={inputStyle} onFocus={e => e.target.style.borderColor='rgba(255,255,255,0.24)'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
