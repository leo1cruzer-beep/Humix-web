            ...
            <div style={card}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  ...
                  <input value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. DevOps Engineer, Marketing Manager" style={inputStyle} onFocus={e => e.target.style.borderColor='rgba(255,255,255,0.24)'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
                <div>
                  <label style={labelStyle}>Country / Market</label>
                  <input value={country} onChange={e => setCountry(e.target.value)} placeholder="e.g. Canada, Nigeria, Germany" style={inputStyle} onFocus={e => e.target.style.borderColor='rgba(255,255,255,0.24)'} onBlur={e => e.target.style.borderColor='var(--border)'} />
                </div>
                <div>
