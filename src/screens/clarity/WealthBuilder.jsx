...
async function callAI(content) {
  const sessionId = `finance-wealth-${Date.now()}`
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{ width: '100%', accentColor: '#1B4FD8' }}
                  />
                ...
                <AreaChart data={data} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                  <defs>
                    <linearGradient id="wGrad1" x1="0" y1="0" x2="0" y2="1">
                      ...
                      <stop offset="100%" stopColor="#1B4FD8" stopOpacity={0.02} />
                    </linearGradient>
                  ...
                  <Area type="monotone" dataKey="With Returns" stroke="#1B4FD8" fill="url(#wGrad1)" strokeWidth={2.5} dot={false} />
                </AreaChart>
              </ResponsiveContainer>
            </div>
